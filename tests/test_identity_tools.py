...
def test_normalize_cpf_rejects_values_without_eleven_digits() -> None:
    for value in ["", "123", "123456789012", "１２３４５６７８９０１"]:
        with pytest.raises(IdentityInputError, match="11 digits"):
            normalize_cpf(value)


def test_parse_birth_date_accepts_supported_formats() -> None:
    for value in ["20/05/1990", "1990-05-20"]:
